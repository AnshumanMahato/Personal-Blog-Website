...
function Header() {
  ...
  return (
    <>
      <header className="relative z-50 flex justify-between items-center  p-[2rem] xs:p-[3rem] text-[2.5rem] xs:text-[3rem] leading-[140%] w-full max-w-[800px]">
        <Link
          href="/"
        ...
        <div className="md:hidden hover:text-accent-dark transition-colors duration-200 cursor-pointer">
      ...
      <AnimatePresence mode="wait">
        {isOpen && (
          <motion.nav
            key="nav-bg"
            className="lg:hidden absolute top-0 z-40 w-screen h-screen flex justify-center items-center bg-black/20 backdrop-blur-[20px] shadow-[0_0_3rem_3rem_rgba(255,255,255,0.11)_inset]"
            initial={{
              x: "100%",
            }}
            animate={{ x: 0 }}
