...
function BlogCard({ post }: Props) {
  return (
    ...
    >
      <div className="cursor-pointer w-full flex flex-col gap-[5px] p-[8px] xs:p-[1rem] sm:p-[2rem] sm:pr-[7rem] border-b-[1px] border-b-secondary-dark [&:hover>h3]:text-accent-dark">
