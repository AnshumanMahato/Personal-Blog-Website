...
function PageBanner({ title, coverImage, coverImageAlt }: Props) {
  return (
    <section className="col-span-full flex flex-col gap-[2rem]">
      ...
      <div className="relative w-full aspect-w-2 aspect-h-1 sm:aspect-w-7 sm:aspect-h-3 overflow-hidden bg-secondary-light dark:bg-secondary-dark rounded-[1rem] sm:rounded-[2rem] drop-shadow-xs">
        <Image
          src={coverImage}
          alt={coverImageAlt}
          fill
